    ...
    return (
            <div className="header-wrapper">
                <div className="main-info">
                    ...
                    <p className="intro1">HEEJAE is a cross-functional and multicultural product designer who has work experiences with global UX agencies. He specializes in product design and UX/UI design for uncovering insights and translating it to design. His purpose of design is creating highly focused user-centered products.</p>
