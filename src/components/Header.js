    ...
    return (
            <div id="home" className="header-wrapper border-bottom">
                <div className="main-info">
                    ...
                    <p className="intro1">HEEJAE is a Hospitality Industry based service designer with great empathy. He specializes in service design and interaction design for uncovering insights and translating it to design concepts. His purpose of design is creating highly focused user experiences and user-centered products</p>
